...
namespace Backtrace.Unity
{
    ...
    public class BacktraceClient : MonoBehaviour, IBacktraceClient
    {
        ...
        public void Refresh()
        {
            ...
            // The Apple native client owns its native storage independently of the managed offline database.
            // Keep other platforms' prerequisites intact.
            bool initializeNativeClient = Database != null;
#if (UNITY_STANDALONE_OSX || UNITY_IOS) && !UNITY_EDITOR
            // Refresh can run again when DestroyOnLoad leaves Instance unset.
            // Retain the owner: replacing it with a duplicate would lose its shutdown path.
            initializeNativeClient = _nativeClient == null && Configuration.CaptureNativeCrashes;
#endif
