...
Backtrace Unity users can upload symbols from Untiy Editor to Backtrace. This feature might be really usefull if you would like to have better debugging experience. Uploaded symbols will improve stack trace generated by native crash on Android. 
